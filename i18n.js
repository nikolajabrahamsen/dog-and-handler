...
const TRANSLATIONS = {
  da: {
    ...
    location_label: 'Sted',
    location_url_label: 'Link til kort (valgfrit)',
    location_url_note: 'Kort-link laves automatisk ud fra "Sted" (Google Maps, Apple Maps eller Android-kortvælger, afhængig af enhed). Udfyld kun dette for at bruge et bestemt link i stedet.',
    ...
    add_participant_note: 'Kun navn er påkrævet - tilføj e-mail/telefon nu eller senere.',
    move_btn: 'Flyt',
  ...
  en: {
    ...
    location_url_label: 'Map link (optional)',
    location_url_note: 'A map link is generated automatically from "Location" (Google Maps, Apple Maps, or the Android map picker, depending on device). Only fill this in to use a specific link instead.',
    ...
    add_participant_note: "Only name is required - add email/phone now or later.",
    move_btn: 'Move',
